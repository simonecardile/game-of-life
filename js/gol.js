...
function startStopGol() {
	let startstop = document.querySelector('#buttonStartStop');
	if (!started) {
		started = true;
...
window.onload = () => {
	...
	createGenArrays();
	initGenArrays();
	document.querySelector('#buttonStartStop').addEventListener('click', startStopGol);
	document.querySelector('#buttonReset').addEventListener('click', resetWorld);
}
